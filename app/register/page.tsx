                ...
                <div className="mx-auto w-full max-w-xl flex-1 py-6">
                    ...
                    <Form {...form}>
                        ...
                        >
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (parts.length >= 2) {
                                                        ...
                                                        setNameErr("Contact person name must include both first and last name");
                                                        // Invalidate until both names are present
                                                ...
                                                className="mt-1 bg-zinc-50 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700"
                                            />
                                            <p className={"text-sm font-medium text-destructive"}>{nameErr}</p>
                                        </FormItem>
                                        <FormField
                                            control={form.control}
                                            name="designation"
                                            render={({field}) => (
                                                <FormItem className="sm:col-span-1">
                                                    ...
                                                    <Input
                                                        {...field}
                                                        type="text"
                                                        placeholder="Your role or designation in the organization"
                                                        className="mt-1 bg-zinc-50 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700"
                                                    />
                                                    <FormMessage/>
                                                </FormItem>
                            ...
                            {error && (
                                <div
                                    className="rounded-md border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-700 dark:border-rose-800 dark:bg-rose-900/30 dark:text-rose-200">
                                    {error}
                                </div>
                            )}
