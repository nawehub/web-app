...
import {LiveIndicator} from "@/app/lyd/_components/live-indicator"
...
export default function LYDPage() {
    ...
    const {contributors, rankings, isLive, sseError} = useContributionStream()
    const isMobile = useIsMobile()

    const totalStats = {
        totalContributions: rankings.reduce(
            (sum, r) => sum + (r.totalContributions?.amount ?? 0), 0
        ),
        totalContributors: rankings.reduce((sum, r) => sum + (r.totalContributors ?? 0), 0),
        activeDistricts: allDistricts.length,
        fundedProjects: 127,
    }

    if (showDonationForm) {
        return redirect("/lyd/contribution/new")
    }

    if (showDonationHistory) {
        return redirect("/lyd/contribution/history")
    }
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white dark:bg-zinc-950">
            ...
            <section className="relative pt-32 pb-16 overflow-hidden">
                <div
                    className="absolute inset-0 bg-gradient-to-br from-rose-50/50 via-white to-pink-50/30 dark:from-zinc-950 dark:via-zinc-900 dark:to-rose-950/10"/>
                <div
                    className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-gradient-to-br from-rose-400/10 to-pink-400/10 rounded-full blur-3xl"/>
                ...
                <div className="container relative">
                    ...
                    >
                        <div
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/10 border border-rose-500/20">
                        ...
                        <p className="text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
                            Build a community through voluntary micro-contributions. Every Leone counts towards
                            district development projects that create lasting impact.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
                            <Link
                                href="/lyd/contribution/new"
                                className="flex items-center bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white font-semibold rounded-xl shadow-lg shadow-rose-500/25 hover:shadow-xl hover:shadow-rose-500/30 transition-all duration-300 h-12 px-8"
                            >
                                <Plus className="mr-2 h-5 w-5"/>
                                Make a Contribution
                            </Link>
                            <Link
                                href="/lyd/contribution/history"
                                className="flex items-center border-2 border-zinc-200 dark:border-zinc-800 hover:border-rose-300 dark:hover:border-rose-600 rounded-xl h-12 px-8"
                            >
                        ...
                        return (
                            ...
                            >
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    <div
                                        className={`w-10 h-10 rounded-xl bg-gradient-to-r ${stat.gradient} flex items-center justify-center`}
                                    >
            ...
            <section className="py-8 container">
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <motion.div initial={{opacity: 0, x: -20}} animate={{opacity: 1, x: 0}} transition={{delay: 0.2}}>
                        <Card
                            className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl shadow-zinc-200/50 dark:shadow-zinc-900/50">
                            <CardHeader className="pb-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <CardTitle className="flex items-center gap-3 text-xl">
                                            <div
                                                className="w-10 h-10 rounded-xl bg-gradient-to-r from-yellow-500 to-amber-500 flex items-center justify-center">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <LiveIndicator isLive={isLive} hasError={sseError}/>
                                ...
                                <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2">
                                    <AnimatePresence>
                                        {rankings.map((district, index) => {
                                            const total = totalStats.totalContributions || 1
                                            const percentage =
                                                ((district.totalContributions?.amount ?? 0) / total) * 100
                                            return (
                                                <motion.div
                                                ...
                                                >
                                                    <div
                                                        className={`flex items-center justify-center w-8 h-8 rounded-xl font-bold text-sm ${
                                                            index < 3
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            <div
                                                                className="flex-1 bg-zinc-200 dark:bg-zinc-700 rounded-full h-2 overflow-hidden">
                                                                <motion.div
                                                            ...
                                                            <span
                                                                className="text-xs text-zinc-500 dark:text-zinc-400 w-12 text-right">
                            ...
                            <CardHeader className="pb-4">
                                <div className="flex items-center justify-between gap-4">
                                    <div>
                                        <CardTitle className="flex items-center gap-3 text-xl">
                                            <div
                                                className="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center">
                            ...
                            <CardContent className="p-4 md:p-6">
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div
                                                            className="w-10 h-10 rounded-xl bg-white dark:bg-zinc-800 flex items-center justify-center text-sm font-semibold text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
                                                            {initials}
                                                        </div>
                                ...
                                <span className="text-xs text-zinc-500 dark:text-zinc-400 truncate">
                                  {isAnon ? "Private contributor" : contributor.nationality}
                                                                ...
                                                                >
                                                                    {contributor.totalContributionsCount} {countLabel}
                                                                </Badge>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="text-right">
                                                            <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">
                                                                {formatCurrency(contributor.totalContributions?.amount ?? 0)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </motion.div>
            ...
            <section className="py-16 container">
                <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{delay: 0.4}}>
                    <Card
                        className="relative overflow-hidden border-0 bg-gradient-to-br from-rose-600 via-pink-600 to-red-600">
