...
export default function Login() {
    ...
    return (
        <div className="flex-1 flex items-center justify-center px-4 py-20 lg:py-32">
            {/* Background Elements */}
            <div
                className="fixed inset-0 bg-gradient-to-br from-emerald-50/30 via-white to-teal-50/20 dark:from-zinc-950 dark:via-zinc-900 dark:to-emerald-950/10 -z-10"/>
            <div
                className="fixed top-1/4 -left-32 w-96 h-96 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full blur-3xl -z-10"/>
            <div
                className="fixed bottom-1/4 -right-32 w-96 h-96 bg-gradient-to-br from-blue-400/10 to-indigo-400/10 rounded-full blur-3xl -z-10"/>
            ...
            <div className="w-full max-w-md space-y-8">
                ...
                {/* Login Card */}
                <div
                    className="bg-white dark:bg-zinc-900 rounded-3xl shadow-xl shadow-zinc-200/50 dark:shadow-zinc-900/50 border border-zinc-100 dark:border-zinc-800 p-8">
                    ...
                    {/* Sign Up Link */}
                    <Link href="/web/register" className="block">
                        <Button
                            type="button"
                            variant="outline"
                ...
                {/* Trust Indicators */}
                <div
                    className="flex flex-wrap items-center justify-center gap-6 text-sm text-zinc-500 dark:text-zinc-400">
                ...
                <div className="text-center text-xs text-zinc-500 dark:text-zinc-400 space-y-2">
                    ...
                    <p>
                        <Link href="/web/privacy" className="text-emerald-600 dark:text-emerald-400 hover:underline">
                            Privacy Policy
                        </Link>
                        {" · "}
                        <Link href="/web/terms" className="text-emerald-600 dark:text-emerald-400 hover:underline">
                            Terms of Service
                        </Link>
                    </p>
                </div>
