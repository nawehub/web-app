                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div className="flex shrink-0 flex-wrap items-center justify-end gap-2">
                            <Button
                                ...
                                variant="outline"
                                size="sm"
                                disabled={vettingCase.status !== "approved"}
                                title={
                                    vettingCase.status !== "approved"
                                        ? "Only approved entrepreneurs can be featured"
                                        : isFeatured
                                          ? "Remove from landing page featured slots"
                                          : "Add to landing page featured slots"
                                }
                                className={cn(
                                    "rounded-full",
                                    vettingCase.status !== "approved" &&
                                    ...
                                    vettingCase.status === "approved" &&
                                        (isFeatured
                                            ? "border-amber-400 bg-amber-50 text-amber-900 hover:bg-amber-100 dark:border-amber-600 dark:bg-amber-950/50 dark:text-amber-200 dark:hover:bg-amber-950/70"
