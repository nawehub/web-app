...
export function ClothBorder({ tone }: { tone?: string }) {
    return (
        <div className="h-3 w-full overflow-hidden" aria-hidden="true">
            <svg width="100%" height="100%" preserveAspectRatio="none">
                <pattern id="footer-cloth-border" width="24" height="12" patternUnits="userSpaceOnUse">
                    <path d="M0 6 L12 0 L24 6 L12 12 Z" fill="hsl(25 95% 53%)" fillOpacity="0.55" />
                </pattern>
                <rect width="100%" height="100%" fill="url(#footer-cloth-border)" />
            </svg>
        </div>
    )
}
...
export function Logo() {
    return (
        <Link href="/web" className="flex shrink-0 items-center gap-2.5">
            ...
            />
            <span className="text-xl font-semibold [font-family:var(--font-display)] text-[hsl(var(--color-neutral-50))]">
                NaWe
